...
class Test_Square_Update_Args_Kwargs(unittest.TestCase):
    ...
    def test_update_arg_0(self):
        s = Square(5)
        s.update()
        self.assertEqual("[Square] (28) 0/0 - 5", str(s))
    ...
    def test_update_x(self):
        s = Square(5)
        s.update(x=12)
        self.assertEqual("[Square] (32) 12/0 - 5", str(s))

    def test_update_size_y(self):
        s = Square(5)
        s.update(size=7, y=1)
        self.assertEqual("[Square] (31) 0/1 - 7", str(s))
...
class Test_Square_to_dictionnary(unittest.TestCase):
    ...
    def test_to_dictionary(self):
        ...
        self.assertEqual({'id': 34, 'size': 10, 'x': 2, 'y': 1}, s1_dictionary)
...
class Test_Square_str(unittest.TestCase):
    ...
    def test_str(self):
        s1 = Square(3, 1, 3)
        s1_str = s1.__str__()
        self.assertEqual("[Square] (33) 1/3 - 3", str(s1_str))
